...
@app.route('/image/<image_name>')#可以直接在浏览器中输入http://127.0.0.1:5000/image/a070a54f7c3411e78d8198541b2414bc.jpg查看这张图片
...
@app.route('/pageDetail/addcomment/', methods={'post'})
@login_required
def add_comment():
